"""
Base Engine for Store Builder

This module defines the abstract base class for store generation engines.
"""
...
class EngineResult(BaseModel):
    """Result of a store engine execution."""
...
class BaseStoreEngine(ABC):
    """
    Abstract base class for store generation engines.
    
    Each engine generates a specific part of the store.
    ...
    async def generate(self, context: Dict[str, Any]) -> EngineResult:
        """Generate store component using AI."""
        pass
