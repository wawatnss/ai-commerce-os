...
from .moq_rule import MOQRule
from .availability_rule import AvailabilityRule
from .reliability_rule import ReliabilityRule
from .flexibility_rule import FlexibilityRule
from .data_quality_rule import DataQualityRule


class RuleRegistry:
    """
    Registry for managing supplier evaluation rules.
...
def initialize_registry() -> None:
    ...
    registry.register(CostRule, "cost")
    registry.register(DeliveryRule, "delivery")
    registry.register(MOQRule, "moq")
    registry.register(AvailabilityRule, "availability")
    registry.register(ReliabilityRule, "reliability")
    registry.register(FlexibilityRule, "flexibility")
    registry.register(DataQualityRule, "data_quality")
